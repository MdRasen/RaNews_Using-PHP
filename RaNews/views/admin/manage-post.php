...
<!-- Delete Post Modal -->
<div class="modal fade" id="deletePostModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="add-post.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                <select name="category_id" class="form-control">
                                    ...
                                    if (mysqli_num_rows($categories) > 0) {
                                        foreach ($categories as $item):
                                            ?>
                                            <option value="<?= $item['id'] ?>" <?= isset($_GET['category_id']) == true ? ($_GET['category_id'] == $item['id'] ? 'selected' : '') : '' ?>>
                                                <?= $item['name'] ?>
                                            </option>
                                            <?php
                                        endforeach;
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($postsRes) > 0) {
                                    foreach ($postsRes as $item):
                                        ?>
                                        <tr>
                                            <td><img src="../../<?= $item['postImage'] != "NULL" ? $item['postImage'] : 'assets/admin/img/no-photo.jpg' ?>"
                                                    alt="image" style="width: 50px; height: 50px; object-fit: cover;"></td>
                                            <td>
                                                <?= $item['title'] ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" value="<?= $item['postId'] ?>"
                                                    class="btn btn-sm btn-danger postDeleteBtn">
